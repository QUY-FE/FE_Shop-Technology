...
import SignInURL  from "#/assets/images/sign_in_page_img.jpg";
    ...
    return(
        <div className="w-full h-screen flex">
            <div className="hidden  lg:block w-6/12">
                <Image src={SignInURL}  alt="Ảnh Đăng nhập" />
            </div>
            <div className="w-full lg:w-6/12">
                <form method="POST" className="w-full h-full pt-[100px] px-[10px] md:px-[16px] lg:pl-[130px]" onSubmit={(e) => handleOnSubmit(e)}>
                    ...
                    <p className="w-full h-[30px] mt-10 text-center text-black/80">
                        Bạn đã có tài khoản? 
                           <span className="ml-3 pb-0.5 font-semibold  border-b-2 border-[#b3b3b3] "><Link  href='/log-in'>Đăng nhập</Link></span>
                    </p>
                </form>
            </div>
        </div>
